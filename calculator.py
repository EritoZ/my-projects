...
In order to use it, you need to separate the numbers and arithmetic symbols with a single space like this - X + Y or (X - Y).
Otherwise it will explode. Currently, it only supports addition, subtraction, multiplication and division.
